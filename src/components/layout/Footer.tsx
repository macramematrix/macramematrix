...
const shopLinks = [
  ...
  { href: "/shop?category=gifts-festive", label: "Gifts & Festive" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                href="https://wa.me/918262995455"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-white/60 text-sm font-body hover:text-white transition-colors"
              >
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-xs font-body">
            &copy; {new Date().getFullYear()} Macrame Matrix. All rights reserved.
          </p>
          <p className="text-white/40 text-xs font-body">
